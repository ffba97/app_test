...
CREATE PROCEDURE createUser(usr_name VARCHAR(20),  usr_pass VARCHAR(255), usr_rol INT)
LANGUAGE SQL
AS $$
INSERT INTO users(username,password,id_rol) VALUES(usr_name,usr_pass,usr_rol)
$$;
